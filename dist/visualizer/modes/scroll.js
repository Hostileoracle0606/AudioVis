...
exports.prepareScroll = prepareScroll;
exports.renderScroll = renderScroll;
const pitchPalette_js_1 = require("../pitchPalette.js");
function getScrollModeData(state, width) {
    const existing = state.modeData.scroll;
 ...
 */
function prepareScroll(state, width) {
    ...
    for (let col = 0; col < W; col++) {
        ...
        for (let dr = -barH; dr <= barH; dr++) {
            ...
            if (theme.colorEnabled) {
                ...
                cell = (0, pitchPalette_js_1.pitchAnsiColor)(state.pitchHue, state.pitchSaturation, intensity) + ch + theme.reset;
            }
