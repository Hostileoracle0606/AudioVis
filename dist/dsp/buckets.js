 ...
 */
function buildBucketRanges(numBuckets, numBins, sampleRate) {
 ...
 */
function computeBuckets(magnitudes, numBuckets, sampleRate, peak) {
    ...
    if (max > peak.value)
        ...
        peak.value *= 0.9998; // slow decay so display doesn't get stuck dark
