...
exports.renderSkyline = renderSkyline;
...
function renderSkyline(state, renderer, region, theme) {
    ...
    for (let building = 0; building < buildingCount; building++) {
        ...
        const bucketEnd = Math.max(bucketStart + 1, Math.floor(((building + 1) * state.smoothedBuckets.length) / buildingCount));
