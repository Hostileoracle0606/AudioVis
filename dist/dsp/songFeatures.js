...
exports.SongFeatureTracker = void 0;
const EMPTY = {
    bpm: 0,
    tempoPhase: 0,
    brightness: 0,
...
const ONSET_RING = 16;
class SongFeatureTracker {
    onsetTimes = []; // wall-clock ms of recent onsets
    lastOnsetMs = 0;
    lastPulseValue = 0;
    ...
    rmsWindow = [];
    rmsWindowSize = 300; // 10s at 30fps
    currentBpm = 0;
    beatPhaseAnchorMs = 0; // time of the most recent accepted beat
    out = { ...EMPTY };
    reset() {
     ...
     */
    update(low, mid, high, rms, pulse, nowMs) {
        ...
        if (pulse > ONSET_TH &&
            ...
            if (this.lastOnsetMs > 0) {
                ...
                if (ioi > 250 && ioi < 1500) {
                    ...
                    if (this.onsetTimes.length > ONSET_RING)
...
exports.SongFeatureTracker = SongFeatureTracker;
function meanStd(xs) {
    if (xs.length === 0)
...
//# sourceMappingURL=songFeatures.js.map