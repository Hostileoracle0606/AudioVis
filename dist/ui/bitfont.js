...
exports.GLYPHS = exports.GLYPH_W = exports.GLYPH_H = void 0;
exports.renderBigLine = renderBigLine;
exports.renderMiniLine = renderMiniLine;
exports.renderTinyLine = renderTinyLine;
exports.compressToHalfBlock = compressToHalfBlock;
exports.GLYPH_H = 8;
exports.GLYPH_W = 6;
 ...
 */
function renderBigLine(text) {
    const upper = text.toUpperCase();
    const lines = new Array(exports.GLYPH_H).fill("");
    for (let i = 0; i < upper.length; i++) {
        const ch = upper[i];
        const glyph = exports.GLYPHS[ch] ?? exports.GLYPHS[" "];
        for (let r = 0; r < exports.GLYPH_H; r++) {
            lines[r] += glyph[r];
            if (i < upper.length - 1)
                lines[r] += " ";
        }
 ...
 */
function compressToHalfBlock(rows) {
    const out = [];
...
//# sourceMappingURL=bitfont.js.map