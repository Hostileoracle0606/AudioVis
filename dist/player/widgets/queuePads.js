...
exports.renderQueuePads = renderQueuePads;
 ...
 */
function renderQueuePads(r, region, state, theme) {
    ...
    const trackId = state.nowPlaying
        ...
        : null;
    const dna = trackId ? (0, trackDna_js_1.computeDna)(trackId) : null;
    const bpm = dna?.bpm ?? 120;
    const frame = (0, padSequencer_js_1.computePadFrame)(trackId, bpm, state.progressMs, state.lastTransientAt, Date.now());
...
function drawPad(r, x, y, index, pattern, isActive, flashing, theme) {
...
//# sourceMappingURL=queuePads.js.map